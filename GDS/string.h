...
_Check_return_ inline char * __CRTDECL strL(_In_z_ char * _Str, _In_ int _Ch)
...
_Check_return_ _CRT_NONSTDC_DEPRECATE(_strnicmp) _CRTIMP int __cdecl strnname(_In_z_ const char * _Str1, _In_z_ const char * _Str, _In_ size_t _MaxCount);
